          ...
          <div className="projektDiv">
            ...
            <Collapsible trigger="Details" >
              <div className="projectDetails">
                <div>
                  <p>This prototype allows to chat with the same people about different topics at the same time. The user can swipe through the topics. They are sorted by the last message. Answering to a message directly generates a new topic. The project is a work in progress.</p>
            ...
            <Collapsible trigger="Details">
              <div className="projectDetails">
                <div>
                  ...
                  <p>A special challenge was implementing the game logic in JavaScript. Since the game has many ways to go, a lot of testing was necessary to make sure everything is working properly. </p>
